...
<svg {{ $attributes->merge(['class' => $class]) }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @switch($name)
        ...
        @case('chevron-last')
            ...
            @break
        @case('chevron-first')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7M5 5v14"></path>
            @break
        @case('menu')
        ...
        @case('image')
            ...
            @break
        @case('check-circle')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM9 12l2 2 4-4"></path>
            @break
        @case('gift')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6m16 0V9a2 2 0 00-2-2h-3m3 3H4m16 0h-2m-8 10V7m0 0a3 3 0 10-3-3M12 7a3 3 0 113-3m-3 3H9m3 0h3M4 12V9a2 2 0 012-2h3m-5 5h2" />
            @break
        @case('map-pin')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
            @break
        @case('cart')
